...
3. **AI Agent Integration**: If the spec mentions an AI agent, create the necessary API endpoints and frontend components for it.
4. **Output**: Dump your code perfectly into the `app_build/` directory. Do not skip or summarize any code blocks. Ensure all `package.json` or `requirements.txt` files are present.
